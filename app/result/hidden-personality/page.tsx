...
const results = {
  quiet_strategist: {
    ...
    summary:
      "You notice patterns, read situations carefully, and think before you move.",
    desc1:
    ...
    bestMatch:
      "Someone steady and emotionally intelligent who respects your quiet depth",
  },

  gentle_idealist: {
    title: "The Gentle Idealist 🌸",
    summary:
      "You are guided by empathy, sincerity, and a strong inner sense of what matters.",
    desc1:
    ...
    watchOut:
      "Taking on too much emotional weight, idealizing people too quickly",
    bestMatch:
      "Someone honest and grounded who values kindness as much as you do",
  },

  curious_explorer: {
    title: "The Curious Explorer 🧭",
    summary:
      "You are driven by discovery, fresh experiences, and the thrill of learning something new.",
    desc1:
    ...
    bestMatch:
      "Someone flexible and open-minded who enjoys exploring life with you",
  },

  calm_thinker: {
    title: "The Calm Thinker 🌙",
    summary:
      "You bring emotional balance, reflection, and quiet clarity to situations around you.",
    desc1:
    ...
    bestMatch:
      "Someone patient and warm who appreciates depth without needing constant intensity",
  },

  natural_leader: {
    title: "The Natural Leader 🔥",
    summary:
      "You carry initiative, direction, and an energy that naturally pulls others forward.",
    desc1:
    ...
    watchOut:
      "Impatience, unintentionally overwhelming quieter people",
    bestMatch:
      "Someone secure and supportive who respects your drive without competing with it",
  },

  creative_mind: {
    title: "The Creative Mind 🎨",
    summary:
      "You see possibilities, ideas, and beauty in places other people often overlook.",
    desc1:
    ...
    bestMatch:
      "Someone open-minded who appreciates your depth and gives your ideas room to grow",
  },
} as const;
