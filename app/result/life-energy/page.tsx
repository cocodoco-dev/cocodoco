...
const results = {
  fire_energy: {
    title: "Fire Energy 🔥",
    summary:
      "Your life energy is driven by passion, motion, and the urge to ignite change.",
    desc1:
    ...
    bestMatch:
      "Someone grounded enough to steady your fire without putting it out",
  },

  water_energy: {
    title: "Water Energy 🌊",
    summary:
      "Your life energy is emotional, flowing, and deeply connected to what is real beneath the surface.",
    desc1:
    ...
    bestMatch:
      "Someone calm and emotionally steady who respects your depth",
  },

  wind_energy: {
    title: "Wind Energy 💨",
    summary:
      "Your life energy is free, changing, and always moving toward something new.",
    desc1:
    ...
    bestMatch:
      "Someone adventurous but grounded enough to help you stay anchored",
  },
  ...
  earth_energy: {
    ...
    bestMatch:
      "Someone warm and alive who respects your pace while gently expanding your world",
  },

  light_energy: {
    title: "Light Energy ✨",
    summary:
      "Your life energy feels hopeful, uplifting, and naturally healing to be around.",
    desc1:
    ...
    bestMatch:
      "Someone genuine and emotionally mature who values your warmth without depending on it",
  },

  shadow_energy: {
    title: "Shadow Energy 🌑",
    summary:
      "Your life energy is deep, introspective, and shaped by what most people overlook.",
    desc1:
    ...
    bestMatch:
      "Someone patient and emotionally grounded who is not afraid of depth",
  },
} as const;
