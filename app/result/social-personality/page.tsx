...
const results = {
  connector: {
    title: "The Connector 🤝",
    summary:
      "You naturally bring people together and make relationships feel easier.",
    desc1:
    ...
    watchOut:
      "Over-functioning for others, trying to hold every relationship together",
    bestMatch:
      "Someone kind and socially aware who also knows how to meet you halfway",
  },
  ...
  listener: {
    ...
    bestMatch:
      "Someone emotionally mature who values depth and reciprocity",
  },

  storyteller: {
    title: "The Storyteller 🎙️",
    summary:
      "You bring personality, humor, and memorable energy into social spaces.",
    desc1:
    ...
    watchOut:
      "Feeling pressure to always be 'on', using performance to hide vulnerability",
    bestMatch:
      "Someone playful and emotionally real who enjoys your spark without depending on it",
  },

  observer: {
    title: "The Observer 👀",
    summary:
      "You understand people quietly and often notice what others completely miss.",
    desc1:
    ...
    bestMatch:
      "Someone patient and perceptive who values depth over noise",
  },

  energizer: {
    title: "The Energizer ⚡",
    summary:
      "You bring movement, excitement, and social momentum wherever you go.",
    desc1:
    ...
    bestMatch:
      "Someone warm and steady who enjoys your spark without draining it",
  },

  calm_presence: {
    title: "The Calm Presence 🌿",
    summary:
      "You make social spaces feel steadier, softer, and easier to exist in.",
    desc1:
    ...
    bestMatch:
      "Someone emotionally balanced who appreciates peace and genuine connection",
  },
} as const;
