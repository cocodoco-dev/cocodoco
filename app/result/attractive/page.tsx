...
const results = {
  warm_charm: {
    title: "Warm Charm 💗",
    summary: "What makes you attractive is the way people feel safe, relaxed, and emotionally seen around you.",
    desc1:
    ...
    bestMatch: "Someone emotionally mature who values gentleness and reciprocity",
  },

  quiet_mystery: {
    title: "Quiet Mystery 🌙",
    summary: "What makes you attractive is the sense that there is always more to you than people can immediately read.",
    desc1:
    ...
    bestMatch: "Someone patient and perceptive who enjoys depth rather than needing instant clarity",
  },

  playful_magnetism: {
    title: "Playful Magnetism 😼",
    summary: "What makes you attractive is your ability to make people feel alive, playful, and emotionally awake.",
    desc1:
    ...
    bestMatch: "Someone confident and emotionally clear who can enjoy your spark without getting lost in it",
  },

  elegant_energy: {
    title: "Elegant Energy ✨",
    summary: "What makes you attractive is your composed presence, quiet confidence, and natural sense of refinement.",
    desc1:
    ...
    bestMatch: "Someone grounded and emotionally secure who appreciates quiet confidence",
  },

  bright_presence: {
    title: "Bright Presence ☀️",
    summary: "What makes you attractive is the way your energy lights up people and spaces almost instantly.",
    desc1:
    ...
    watchOut: "Feeling pressure to always be positive, over-giving your energy",
    bestMatch: "Someone steady and genuine who enjoys your brightness without depending on it constantly",
  },

  deep_allure: {
    title: "Deep Allure 🖤",
    summary: "What makes you attractive is your emotional depth, quiet intensity, and the feeling that you mean more than you say.",
    desc1:
    ...
    bestMatch: "Someone emotionally strong and patient who is not afraid of depth",
  },
} as const;
