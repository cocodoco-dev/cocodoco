...
const results = {
  dreamer_mind: {
    ...
    summary:
      "Your mind naturally moves toward possibility, imagination, and what life could become.",
    desc1:
    ...
    bestMatch:
      "Someone supportive and steady who believes in your inner world without trying to shrink it",
  },

  strategist_mind: {
    title: "Strategist Mind ♟️",
    summary:
      "Your mind naturally looks for patterns, direction, and the smartest way forward.",
    desc1:
    ...
    bestMatch:
      "Someone confident and flexible who appreciates your direction without resisting it",
  },

  explorer_mind: {
    title: "Explorer Mind 🧭",
    summary:
      "Your mind feels most alive when it is discovering, expanding, and moving into the unknown.",
    desc1:
    ...
    bestMatch:
      "Someone adventurous and open-minded who enjoys growing with you",
  },

  empath_mind: {
    title: "Empath Mind 💗",
    summary:
      "Your mind is deeply connected to emotion, meaning, and the inner world of people.",
    desc1:
    ...
    bestMatch:
      "Someone grounded and emotionally mature who respects your depth",
  },

  creator_mind: {
    title: "Creator Mind 🎨",
    summary:
      "Your mind is expressive, original, and always shaping something new from what it sees.",
    desc1:
    ...
    watchOut:
      "Self-doubt, losing momentum when ideas are not immediately understood",
    bestMatch:
      "Someone open-minded who gives your ideas room to grow",
  },

  calm_observer_mind: {
    title: "Calm Observer Mind 🌙",
    summary:
      "Your mind is quiet, perceptive, and often understands more than it immediately reveals.",
    desc1:
    ...
    bestMatch:
      "Someone patient and thoughtful who values depth over noise",
  },
} as const;
