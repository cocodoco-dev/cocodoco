...
const results = {
  safe_person: {
    ...
    summary: "People see you as someone they can trust, lean on, and emotionally breathe around.",
    desc1:
    ...
    bestMatch: "Someone honest and emotionally mature who values safety and reciprocity",
  },

  interesting_person: {
    title: "The Interesting One 🌙",
    summary: "People see you as someone with layers, originality, and a mind that feels worth discovering.",
    desc1:
    ...
    watchOut: "Feeling misunderstood, becoming too distant without meaning to",
    bestMatch: "Someone curious and open-minded who appreciates complexity",
  },

  fun_person: {
    title: "The Fun One 🎉",
    summary: "People see you as someone who brings lightness, energy, and joy into their lives.",
    desc1:
    ...
    watchOut: "Feeling pressure to perform, being underestimated emotionally",
    bestMatch: "Someone grounded who enjoys your energy without expecting you to carry every mood",
  },

  calm_person: {
    title: "The Calm One 🌿",
    summary: "People see you as someone steady, peaceful, and easy to exist around.",
    desc1:
    ...
    bestMatch: "Someone thoughtful and warm who values peace without mistaking it for passivity",
  },

  inspiring_person: {
    title: "The Inspiring One ✨",
    summary: "People see you as someone who makes them think bigger, grow, or move differently.",
    desc1:
    ...
    watchOut: "Feeling responsible for fixing or guiding everyone",
    bestMatch: "Someone self-aware and emotionally mature who values growth and mutual encouragement",
  },

  unforgettable_person: {
    title: "The Unforgettable One 🔥",
    summary: "People see you as someone who leaves a lasting mark on their mind, even after a short time.",
    desc1:
    ...
    watchOut: "Being idealized or misunderstood, unintentionally seeming hard to reach",
    bestMatch: "Someone emotionally strong and self-aware who can appreciate depth without projecting onto it",
  },
} as const;
