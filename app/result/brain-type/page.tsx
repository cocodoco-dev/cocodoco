...
const results = {
  analytical_brain: {
    ...
    summary: "Your mind is sharp, structured, and always looking for how things work.",
    desc1:
    ...
    bestMatch: "Someone open-minded who appreciates your precision without fearing complexity",
  },

  creative_brain: {
    title: "Creative Brain 🎨",
    summary: "Your mind is imaginative, expressive, and full of unexpected possibilities.",
    desc1:
    ...
    bestMatch: "Someone curious and supportive who gives your mind room to create",
  },

  strategic_brain: {
    title: "Strategic Brain ♟️",
    summary: "Your mind naturally looks ahead, connects outcomes, and plans the smartest move.",
    desc1:
    ...
    bestMatch: "Someone confident and flexible who can respect your direction without resisting it",
  },

  emotional_brain: {
    title: "Emotional Brain 💗",
    summary: "Your mind understands people deeply and is wired for emotional meaning.",
    desc1:
    ...
    bestMatch: "Someone warm and grounded who respects your sensitivity",
  },

  curious_brain: {
    title: "Curious Brain 🧭",
    summary: "Your mind is driven by discovery, questions, and the excitement of learning something new.",
    desc1:
    ...
    bestMatch: "Someone adventurous and open-minded who enjoys exploring ideas with you",
  },

  balanced_brain: {
    title: "Balanced Brain ⚖️",
    summary: "Your mind blends logic and feeling in a way that feels grounded, thoughtful, and human.",
    desc1:
    ...
    watchOut: "Taking too long to decide, trying too hard to please every side",
    bestMatch: "Someone thoughtful and emotionally mature who values your balanced view",
  },
} as const;
