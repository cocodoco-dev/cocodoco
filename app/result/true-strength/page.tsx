...
const results = {
  empathy: {
    title: "Empathy 💗",
    summary: "Your true strength is the ability to deeply understand and care for people.",
    desc1:
    ...
    bestMatch: "Someone emotionally mature who values your heart and respects your boundaries",
  },

  courage: {
    title: "Courage 🔥",
    summary: "Your true strength is moving forward even when fear is still present.",
    desc1:
    ...
    bestMatch: "Someone grounded who supports your fire without trying to contain it",
  },

  creativity: {
    title: "Creativity 🎨",
    summary: "Your true strength is seeing possibilities that other people often miss.",
    desc1:
    ...
    bestMatch: "Someone open-minded who values originality and encourages your ideas to grow",
  },

  intelligence: {
    title: "Intelligence 🧠",
    summary: "Your true strength is clear thinking, insight, and the ability to understand complexity.",
    desc1:
    ...
    bestMatch: "Someone curious and steady who appreciates depth without making everything feel like a test",
  },

  resilience: {
    title: "Resilience 🌱",
    summary: "Your true strength is your ability to keep going and rebuild, even after hard seasons.",
    desc1:
    ...
    bestMatch: "Someone dependable and caring who values your strength without taking it for granted",
  },

  leadership: {
    title: "Leadership 👑",
    summary: "Your true strength is guiding people and helping things move in the right direction.",
    desc1:
    ...
    bestMatch: "Someone secure and emotionally intelligent who respects your direction and offers honest perspective",
  },
} as const;
