...
const results = {
  cozy_planner: {
    ...
    bestMatch:
      "Someone energetic enough to inspire you, but gentle enough to respect your pace",
  },

  spontaneous_sprinter: {
    title: "Spontaneous Sprinter ⚡",
    summary:
      "You move quickly, trust your instincts, and bring momentum into every room.",
    desc1:
    ...
    bestMatch:
      "Someone curious and flexible who can keep up with your pace",
  },

  curious_collector: {
    title: "Curious Collector 🔍",
    summary:
      "You are driven by discovery, ideas, and the thrill of finding something new.",
    desc1:
    ...
    bestMatch:
      "Someone open-minded who enjoys exploring ideas and experiences with you",
  },

  chill_floater: {
    title: "Chill Floater 🌿",
    summary:
      "You move through life with softness, ease, and very little unnecessary stress.",
    desc1:
    ...
    bestMatch:
      "Someone grounded who appreciates your relaxed energy without trying to control it",
  },

  social_butterfly: {
    title: "Social Butterfly 🦋",
    summary:
      "You bring brightness, connection, and easy warmth into social spaces.",
    desc1:
    ...
    bestMatch:
      "Someone warm and confident who enjoys people but respects your need to recharge",
  },

  quiet_observer: {
    title: "Quiet Observer 🌙",
    summary:
      "You notice what others miss and bring depth into even the quietest moments.",
    desc1:
    ...
    bestMatch:
      "Someone patient and emotionally aware who values depth over noise",
  },
} as const;
